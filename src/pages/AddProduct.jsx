  ...
  const handleSaveProduct = async () => {
    ...
    try {
      ...
      if (warrantyMonths !== null) {
        payload.append("warranty_months", warrantyMonths)
      }
      ...
      if (!res.ok) {
        ...
        throw new Error(errorData?.detail || "Failed to save product. Check console.")
      }
      ...
      Swal.fire("Error!", `Could not save product: ${err.message}`, "error")
    } finally {
      setIsLoading(false)
    }
  }
    ...
    <div className="min-h-screen bg-gray-50">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="md:col-span-2">
                ...
                <input
                  ...
                  className="w-full text-sm text-gray-900 border border-gray-300 rounded-sm p-1.5 cursor-pointer bg-gray-50 focus:outline-none"
                />
      ...
      <div className="flex items-center justify-center">
        <button
          ...
          disabled={isLoading}
          className={`w-full mt-4 py-3 text-lg rounded-lg flex items-center justify-center gap-2 transition-colors ${
            isLoading
