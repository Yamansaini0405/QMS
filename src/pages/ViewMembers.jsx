    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-xl md:text-2xl font-semibold text-gray-900">All Members</h1>
            <p className="text-sm md:text-md text-gray-600">Manage and track system members</p>
          </div>
        </div>
        <Link to="/members/create">
          <button className="bg-gray-900 text-white px-2 py-1 md:px-4 md:py-2 rounded-lg hover:bg-gray-800 transition-colors flex items-center gap-2">
